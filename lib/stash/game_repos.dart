    ...
    for (var y = 0; y < 5; y++) {
      for (var x = 0; x < 5; x++) {
        var element = GameElement(
            pos: ElementPosition(x: x, y: y), icon: icons[rand.nextInt(5)]);
        ...
        try {
          while (element.icon ==
                  elementsList[elementsList.indexOf(element) - 5].icon &&
              element.icon ==
                  elementsList[elementsList.indexOf(element) - 10].icon) {
            elementsList[elementsList.indexOf(element)].icon =
                icons[rand.nextInt(5)];
          }
        } catch (_) {}
